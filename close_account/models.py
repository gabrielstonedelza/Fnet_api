...
class CloseAccount(models.Model):
    ...
    cash_left_at1 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at2 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at3 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at4 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at5 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at6 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at7 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at8 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at9 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
    cash_left_at10 = models.CharField(max_length=100, choices=CASH_LEFT_AT_BRANCHES, default="",blank=True)
